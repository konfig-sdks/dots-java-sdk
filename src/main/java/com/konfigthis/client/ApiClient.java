...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.dots.dev/api";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("api_key", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.dots.dev/api)
